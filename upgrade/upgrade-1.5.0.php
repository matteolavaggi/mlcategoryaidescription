 ...
 *
 * Changes:
 * - New category selector UI with tree structure
 * - Search functionality for categories
 * - Checkbox-based selection with expand/collapse
 * - "Select all subcategories" feature
 *
...
function upgrade_module_1_5_0($module)
{
    ...
    // All changes are in templates, CSS, and JavaScript
    return true;
}
