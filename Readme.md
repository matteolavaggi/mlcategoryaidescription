...
1. **Parallel API Calls** - Process 2-3 items simultaneously
2. **Smarter Batching** - Group by language/field type
3. **Caching** - Skip unchanged categories

### Long-term Improvements

1. **Server-side Queue** - Background processing without browser
2. **Async/Streaming** - Non-blocking API calls with webhooks
3. **Bulk API** - OpenAI Batch API for large jobs (50% cheaper)
4. **Content Diff** - Only regenerate changed categories
